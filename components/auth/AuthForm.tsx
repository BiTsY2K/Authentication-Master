          ...
          <form id="authform" onSubmit={form.handleSubmit(onSubmit)} className="grid gap-6">
            {!showTwoFactor ? (
              ...
              <div className="grid gap-4">
                ...
                {/* Two factor Authentication (2FA) OTP field - Only for Login form */}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Please enter the one-time password sent to your email. If you haven't received it, click Sign In again to request a
                        new one.
                      </FormDescription>
                    </FormItem>
                  )}
                ...
                //       <DialogDescription>Your account has an additional layer of protection with 2FA.</DialogDescription>
                //       <Separator />
                //     </DialogHeader>
                //     <Form {...form}>
                ...
                //         <Input type="password" aria-disabled={isLoading} disabled={isLoading} placeholder="john.doe@example.com" />
